...
import { createContactSchema, updateContactSchema, listContactsQuerySchema } from '@infrastructure/api/validations/contact.schema'
...
export function createContactsController(contactRepository: IContactRepository) {
  const app = new Hono()
  ...
  app.get('/', zValidator('query', listContactsQuerySchema), async (c) => {
